...
fn bindgen_test_layout_basisu_color_rgba__bindgen_ty_1__bindgen_ty_1() {
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<basisu_color_rgba__bindgen_ty_1__bindgen_ty_1>())).r as *const _
                as usize
        },
        0usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<basisu_color_rgba__bindgen_ty_1__bindgen_ty_1>())).g as *const _
                as usize
        },
        1usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<basisu_color_rgba__bindgen_ty_1__bindgen_ty_1>())).b as *const _
                as usize
        },
        2usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<basisu_color_rgba__bindgen_ty_1__bindgen_ty_1>())).a as *const _
                as usize
        },
        3usize,
        concat!(
...
fn bindgen_test_layout_basisu_color_rgba__bindgen_ty_1() {
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<basisu_color_rgba__bindgen_ty_1>())).m_comps as *const _ as usize
        },
        0usize,
        concat!(
            "Offset of field: ",
